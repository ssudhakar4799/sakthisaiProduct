      ...
      <section className="relative overflow-hidden bg-background">
        <div className="relative grid min-h-[560px] items-center md:grid-cols-2">
          ...
          <div className="relative h-[400px] md:absolute md:right-0 md:top-0 md:h-full md:w-[60%]">
            <div className="hero-clip absolute inset-0" style={{ background: "var(--gradient-deep)" }} />
            <div className="relative flex h-full items-center justify-center">
              <div className="absolute h-72 w-72 rounded-full bg-primary-glow/30 blur-3xl md:h-96 md:w-96" />
              <img src={bottle} alt="Silprovet veterinary supplement bottle" width={500} height={500} className="animate-float relative z-10 w-64 drop-shadow-2xl md:w-80" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid items-center gap-10 md:grid-cols-3">
          <div className="flex flex-col items-center gap-6">
            <div className="relative">
              ...
              <img src={bottle} alt="Silprovet bottle" loading="lazy" width={400} height={400} className="w-48 drop-shadow-xl md:w-56" />
            </div>
          ...
          <ul className="space-y-4">
            {benefits.map(({ icon: Icon, text }, i) => (
              <li key={text} className="animate-fade-up hover-lift flex items-center gap-4 rounded-xl bg-card/60 p-3" style={{ animationDelay: `${i * 0.08}s` }}>
          ...
          <div className="flex justify-center">
            <img src={chickens} alt="Healthy poultry" loading="lazy" width={400} height={400} className="w-64 drop-shadow-lg md:w-72" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto grid gap-12 px-6 md:grid-cols-2">
          <div className="animate-fade-up">
            ...
            <p className="leading-relaxed text-muted-foreground">
              Our mission is to advance veterinary wellness and empower healthier lives. Silprovet is engineered through years of research into livestock health—supporting immunity, growth, and overall vitality across cattle, poultry, and small ruminants.
            </p>
          </div>
          ...
          <div className="grid gap-8">
            ...
            <ul className="space-y-3">
              {["Anti-inflammatory", "Impact on the feed antibiotic and medication", "Reduce mortality", "Improve global performance for your livestock"].map((t, i) => (
