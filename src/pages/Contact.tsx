  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <p className="mx-auto mb-12 max-w-xl text-center text-muted-foreground">Have a question or ready to place a wholesale order? Send us a message.</p>
        <div className="grid gap-10 lg:grid-cols-2">
          <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="space-y-4 rounded-2xl bg-card p-8 shadow-sm">
            {sent ? (
